...
FLASH_CONST static const int32_t *hilbert_q15_per_sr_alias[NUM_SR] = { hilbert_q15_per_sr[0], hilbert_q15_per_sr[1],
                                                                       hilbert_q15_per_sr[1] }; /* 48 kHz points to 16 kHz table */
